...
//		
		...
		WebElement TestingTypeAnchor = driver
				.findElement(By.xpath(".//div[contains(text(),'" + TestType + "')]/parent::a"));
...
//		List<WebElement> sprint= driver.findElements(By.xpath(".//div[contains(text(),'Release 2.1')]/parent::a/following-sibling::ul/li"));
		List<WebElement> sprints = driver.findElements(
				By.xpath(".//div[contains(text(),'" + Release + "')]/parent::a/following-sibling::ul/li"));
//		
		for (WebElement sprintEle : sprints) {
			...
			if (expand.size() == 1)
				...
				Thread.sleep(1000);
			if (Sprint.trim().equalsIgnoreCase(
					driver.findElement(By.xpath(".//li[@id='" + sprintId + "']/a/div")).getText().trim())) {
				...
				for (WebElement storyEle : story) {
					storyEle.click();
					Thread.sleep(3000);
					List<WebElement> testcase = driver.findElements(By.xpath(".//span[contains(text(),'Passed')]"));
					...
					for (WebElement testcaseEle : testcase) {
						...
						Thread.sleep(2000);
						List<WebElement> attachment = driver
								.findElements(By.xpath(".//td[@class='iteration-attachment-name']/a"));
						List<WebElement> comment = driver
								.findElements(By.xpath(".//p[contains(text(),'Post Review Done')]"));
						...
						if (attachment.size() != 0 && comment.size() == 0) {
							...
							WebElement ele1 = driver.findElement(
									By.xpath(".//*[@class='identity-picker-dropdown identity-picker-fixed-position']"));

							driver.findElement(By.xpath(".//div[@class='identity-picker-container']/div/span[2]"))
									.click();

							WebElement ele2 = driver.findElement(By.xpath(
									".//div[@class='item-text-container']//span[contains(text(),'Mohammad Parvez')]/parent::div/parent::div/preceding-sibling::div[2]"));

							Thread.sleep(1000);
							WebElement element = driver.findElement(By.xpath(
									".//div[@class='item-text-container']//span[contains(text(),'Mohammad Parvez')]"));
							...
							String noAttachment = driver.findElement(By.xpath(".//td[@class='query-title']//a")).getText();
							Session.writeProperty("Backlog ID: ", noAttachment);
							driver.close();
							Thread.sleep(1000);
							driver.switchTo().window(driver.getWindowHandles().toArray()[0].toString());
						}
